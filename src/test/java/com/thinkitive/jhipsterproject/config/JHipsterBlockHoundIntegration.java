...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.thinkitive.jhipsterproject.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.thinkitive.jhipsterproject.security.DomainUserDetailsService", "createSpringSecurityUser");
