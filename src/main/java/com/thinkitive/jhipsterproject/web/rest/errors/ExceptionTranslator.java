package com.thinkitive.jhipsterproject.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler implements ExceptionTranslation {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.thinkitive.jhipsterproject.service.EmailAlreadyUsedException ||
            ex instanceof com.thinkitive.jhipsterproject.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.thinkitive.jhipsterproject.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(
            ...
            "io.",
            "de.",
            "com.thinkitive.jhipsterproject"
        );
    }
}
